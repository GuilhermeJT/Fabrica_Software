...
O valor de uma fatura é calculado distribuindo-se o cons umo total de água de água pelas faixas de consumo.
...
totalFInal = total + (total * 0.8)

print(f'O valor da fatura é de R${totalFInal:.2f}, sendo R${total:.2f} referente a água e R${total * 0.8:.2f} a esgoto') 